...
describe('RPCWallet atomics tests', () => {
    ...
    it('perform atomic swap between two Nirmata wallets', async () =>{
        const proposal_opts = {
    ...
    xit('atomics_create_htlc_proposal', () => {
        const opts = {
            ...
            counterparty_address: 'iN2EDR1UGhGYcrWpvnnuvkGHHLre4dub961SnbAfB9fx6khF389FgURLHE9VHYq3n12FvJQLcPJjm5VRbLsFZivXhnByyZgfBqh2dsHDCMi5',
