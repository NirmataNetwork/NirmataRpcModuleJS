...
exports = module.exports = {
  walletAddress: process.env.WALLET_ADDRESS || 'http://127.0.0.1:11222',
  walletUsername: process.env.WALLET_USER || 'user',
  walletPassword: process.env.WALLET_PASSWORD || 'pass',
  daemonAddress: process.env.DAEMON_ADDRESS || 'http://127.0.0.1:11232',
  daemonUsername: process.env.DAEMON_USER || 'user',
  daemonPassword: process.env.DAEMON_PASSWORD || 'pass',
  watchOnlyWalletAddress: process.env.WALLET_ADDRESS || 'http://127.0.0.1:11222',
  ...
  integratedTestAddressA: 'iN3ea1cn4rWArhbX3mNPNhb7zpFmmRAgVKJEvaHvmJuQbXxQFFHimjc4j8Hn2G3aRQR3j2sNgkMjcTwBYLhSxkyr1XDXipKrL',
  standardTestAddressA: 'Nn4uBvY5m3pTch1QrxTjmL84Vd91ZCGvWjReNfNbcGkgbdsr9ziqZqL3BC8VTG6FCQPnEhfNStuPJiFfR7AaVow22qMLo79uT',
  ...
  integratedTestAddressB: 'iN3ea1cn4rWArhbX3mNPNhb7zpFmmRAgVKJEvaHvmJuQbXxQFFHimjc4j8Hn2G3aRQR3j2sNgkMjcTwBYLhSxkyr1XDXipKrL',
  standardTestAddressB: 'Nn4uBvY5m3pTch1QrxTjmL84Vd91ZCGvWjReNfNbcGkgbdsr9ziqZqL3BC8VTG6FCQPnEhfNStuPJiFfR7AaVow22qMLo79uT',
